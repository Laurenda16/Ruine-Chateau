...
monstre::monstre(int pointsDeVie, int pointsDeForce, int x, int y, double pctHabilite, bool estAventurier) : personnage{pointsDeVie, pointsDeForce, x, y, estAventurier}, d_pctHabilite{pctHabilite}
{}
